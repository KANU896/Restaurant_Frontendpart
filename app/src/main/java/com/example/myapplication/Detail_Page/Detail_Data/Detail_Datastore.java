...
public class Detail_Datastore implements Serializable {
    ...
    public Detail_Datastore(String id, String Image, String Name, String Score, String Address, String Tag, String Tell_number, boolean Fav){
        this.Id = id;
        this.Image = Image;
        this.Name = Name;
        this.Score = Score;
